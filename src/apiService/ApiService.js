...
import { apiHeaders, baseurl } from "../apiConstants/ApiConstant";
import utils from "../utils/validateUtils";
...
export class apiService {
  ...
  async prepareResponse(request) {
    ...
    try {
      ...
      myError =
        errorStr + ". An unrecognized error occured from the server, check if";
      myError =
        myError +
        " you have an internet connection or server is up, or contact admin";
